...
model.load_weights('./checkpoints/con_score_model')
...
new_model.save_weights('./checkpoints/con_score_model_cross2')
user_encoder = keras.Model(user_input, user_feat)
item_encoder = keras.Model(item_input, item_feat)
user_encoder.save_weights('./checkpoints/con_user_encoder_cross2')
item_encoder.save_weights('./checkpoints/con_item_encoder_cross2')

with open('con_user_final2.npy', 'wb') as f:
    np.save(f, user_encoder(users).numpy())

with open('con_item_final2.npy', 'wb') as f:
